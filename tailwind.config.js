...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      't-md': ['20px', typographyStyles.titleStyles],
      't-sm': ['16px', { ...typographyStyles.titleStyles, lineHeight: '22px' }],
      't-xs': ['14px', { ...typographyStyles.titleStyles, lineHeight: '18px' }],
      'body-lg': ['24px', typographyStyles.bodyStyles],
      'body-md': ['20px', typographyStyles.bodyStyles],
      'body-sm': ['16px', { ...typographyStyles.bodyStyles, lineHeight: '22px' }],
